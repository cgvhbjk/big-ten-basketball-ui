...
export const GLOSSARY = {
  ...
  conf_win_pct:  { label: 'Conf Win %',         definition: 'Win percentage in conference games only.',                                                         calc: 'Conference Wins ÷ Conference Games',              type: 'raw',     group: 'Record' },
  // ── Efficiency ──
  ...
  blk_d:  { label: 'Block Rate (Def)',  definition: 'Percentage of opponent field goal attempts blocked by the defense. The primary signal for rim protection — values above ~11% are elite.', calc: 'Blocks ÷ Opp FGA × 100', type: 'derived', group: 'Defense' },
