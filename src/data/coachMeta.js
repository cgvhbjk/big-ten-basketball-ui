...
//
// Scope: the 18-team Big Ten across the seasons in the dataset (2022–2026,
// where the year is the spring of the season — e.g. 2026 = the 2025–26 season).
...
export const COACH_META = {
  illinois: {
    ...
    2026: { name: 'Brad Underwood', style: 'Spacing-driven offense, aggressive perimeter defense, transition' },
  },
  indiana: {
    ...
    2026: { name: 'Darian DeVries', style: 'Ball-screen offense, perimeter shooting, motion concepts (first season)' },
  },
  iowa: {
    ...
    2026: { name: 'Ben McCollum', style: 'Disciplined motion offense, low turnovers, defense-first (first season)' },
  },
  maryland: {
    ...
    2026: { name: 'Buzz Williams', style: 'High-energy man defense, ball-screen offense, deep rotation (first season)' },
  },
  michigan: {
    ...
    2026: { name: 'Dusty May', style: 'Motion offense, analytics-driven, deep rotation, transition' },
  },
  'michigan-st': {
    ...
    2026: { name: 'Tom Izzo', style: 'Transition off rebounds, physical man defense, balanced scoring' },
  },
  minnesota: {
    ...
    2026: { name: 'Ben Johnson', style: 'Deliberate half-court offense, man-to-man defense' },
  },
  nebraska: {
    ...
    2026: { name: 'Fred Hoiberg', style: 'Spread pick-and-roll, three-point volume, improved defense' },
  },
  northwestern: {
    ...
    2026: { name: 'Chris Collins', style: 'Deliberate half-court, guard-driven offense, stout man defense' },
  },
  'ohio-st': {
    ...
    2026: { name: 'Jake Diebler', style: 'Up-tempo, perimeter-driven, improved spacing and pace' },
  },
  oregon: {
    ...
    2026: { name: 'Dana Altman', style: 'Matchup zone defense, balanced offense, length-based scheme' },
  },
  'penn-st': {
    ...
    2026: { name: 'Mike Rhoades', style: 'Up-tempo, full-court pressure, fast pace' },
  },
  purdue: {
    ...
    2026: { name: 'Matt Painter', style: 'Inside-out scoring, motion offense, drop coverage' },
  },
  rutgers: {
    ...
    2026: { name: 'Steve Pikiell', style: 'Defense-first, low tempo, offensive rebounding' },
  },
  ucla: {
    ...
    2026: { name: 'Mick Cronin', style: 'Defense-first, deliberate half-court, physical man-to-man' },
  },
  usc: {
    ...
    2026: { name: 'Eric Musselman', style: 'Up-tempo, four-out spacing, aggressive defense' },
  },
  washington: {
    ...
    2026: { name: 'Danny Sprinkle', style: 'Man-to-man defense, balanced offense, disciplined execution' },
  },
  wisconsin: {
    ...
    2026: { name: 'Greg Gard', style: 'Modernized swing offense, faster pace, man defense' },
  },
}
